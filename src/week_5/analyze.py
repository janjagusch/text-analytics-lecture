import src.week_5.data.look_at_data as dt

from src.week_5.evaluation import metrics
from src.week_5.features.process_text.tokenization import word_tokenize, ngrams_tokenize, vocabulary_size
from src.week_5.features.process_text.feature_weighting import compute_tfidf, compute_tfidf_stopwords, \
...
def main():
    ...
    print("\nLook at the informaton of a sample stored in position 5 (this is just an example you can try others)\n")
    sample_pos = 5
    ...
    """
    2. Look at an example were we do BOW and n-grams(=2)
